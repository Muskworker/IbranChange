...
class IbranChangeTest < Minitest::Test  
  ...
  def test_consistency
    latin_words = [
      ...
      { w: "metipsimum", RI_IPA: "mɛˈlɛjzm", RI_Cyrl: "мелејзм", RI_Latn: "meleisme", PI_IPA: "məˈlɛjzmə", PI: "meleismă" },
      ...
      { w: "ruptam", RI_IPA: "rɔːt", RI_Cyrl: "ро̄т", RI_Latn: "roete", PI_IPA: "ˈrɔjtə", PI: "roetă" },
      ...
      { w: "septem", RI_IPA: "zɛjt", RI_Cyrl: "зејт", RI_Latn: "seit", PI_IPA: "zɛjt", PI: "seit" },
