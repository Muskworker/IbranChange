...
class IbranChangeTest < Minitest::Test  
  ...
  def test_consistency
    ...
    olf_words = [
      ...
      { w: "strāla", RI_IPA: "ʰtrɑːl", RI_Cyrl: "’тра̄л", RI_Latn: "strale", PI_IPA: "strɑːlə", PI: "strală" },
      { w: "strīpa", RI_IPA: "ʰtriːp", RI_Cyrl: "’трі̄п", RI_Latn: "stripe", PI_IPA: "striːpə", PI: "stripă" },
    ...
    late_latin_words = [
      ...
      { w: "coriandrum", RI_IPA: "kʲɔriˈɑ̃dr", RI_Cyrl: "коріандр", RI_Latn: "coriandre", PI_IPA: "kərəˈɑ̃drə", PI: "coriandră" },
      ...
      { w: "liquidum", RI_IPA: "ˈlikwit", RI_Cyrl: "лікуіт", RI_Latn: "liquid", PI_IPA: "ˈlikwəd", PI: "liquăd" },
      ...
      { w: "materia", RI_IPA: "mɑˈtɛri", RI_Cyrl: "матері", RI_Latn: "materie", PI_IPA: "məˈtɛriːə", PI: "materiă" },
      ...
      { w: "objectum", RI_IPA: "ɔbʝekʲt", RI_Cyrl: "обжикт", RI_Latn: "objécte", PI_IPA: "əbʝektə", PI: "objéctă" },
