...
class IbranChangeTest < Minitest::Test  
  ...
  def test_consistency
    ...
    late_latin_words = [
      ...
      { w: "coriandrum", RI_IPA: "kʲɔriˈʝɑ̃dr", RI_Cyrl: "коріжандр", RI_Latn: "coriandre", PI_IPA: "kərəjˈɑ̃drə", PI: "coriandră" },
      ...
      { w: "diatribas>", RI_IPA: "diʝɑˈtrib", RI_Cyrl: "діжатріб", RI_Latn: "diatribes", PI_IPA: "diːjəˈtribəs", PI: "diatribăs" },
